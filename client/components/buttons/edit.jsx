...
const Edit = ({text,handlemodal}) => {
  return (
    <button onClick={handlemodal} className=" text-gray-500 m-5 border  focus:ring-4 focus:outline-none focus:ring-secondary font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">
              <svg
