...
const Featured = () => {
  return (
    <div><section>
    <div class="max-w-screen-lg px-4 py-8 mx-auto   lg:px-8">
      ...
      <ul class="grid grid-cols-1 gap-4 mt-8 lg:grid-cols-3">
        <li>
          <a href="#" class="relative block group">
            ...
            >
              <h3 class="text-xl font-medium text-white">Burger</h3>
        ...
        <li>
          <a href="#" class="relative block group">
            ...
            <div
              class="absolute inset-0 flex flex-col items-start justify-end p-6"
            >
              <h3 class="text-xl font-medium text-white">French Fries</h3>
        ...
        <li class="lg:col-span-2 lg:col-start-2 lg:row-span-2 lg:row-start-1">
          <a href="#" class="relative block group">
            ...
            <div
              class="absolute inset-0 flex flex-col items-start justify-end p-6"
            >
              <h3 class="text-xl font-medium text-white">Party Jollof</h3>
